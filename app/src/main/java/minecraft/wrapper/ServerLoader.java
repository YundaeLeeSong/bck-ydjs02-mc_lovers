...
public class ServerLoader {
     ...
     */
    public ServerLoader(File serverDir, String serverJarName, String eulaFileName) {
    ...
    /**
     * Checks if the server jar exists, extracting it from resources if missing.
     *
    ...
    private void ensureServerJarExists() throws IOException {
        ...
        if (!serverJar.exists()) {
            System.out.println("Loader: Extracting " + serverJarName + "...");
