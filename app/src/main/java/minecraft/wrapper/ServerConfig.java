 ...
 * Bridges System Environment Variables to the server configuration.
 * </p>
 */
public class ServerConfig {
    ...
    /**
     * Constructs a new ServerConfig manager.
     *
     ...
     * Supported Variables:
     * <ul>
     *   <li>{@code MC_MOTD} -> {@code motd}</li>
     *   <li>{@code MC_MAX_PLAYERS} -> {@code max-players}</li>
     *   <li>{@code MC_ONLINE_MODE} -> {@code online-mode}</li>
     * </ul>
     * </p>
     */
    public void applyEnvironmentVariables() {
        ...
        String onlineMode = System.getenv().getOrDefault("MC_ONLINE_MODE", "true");
